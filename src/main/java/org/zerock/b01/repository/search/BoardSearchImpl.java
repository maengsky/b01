...
public class BoardSearchImpl implements BoardSearch {
    ...
    public Page<BoardListReplyCountDTO> searchWithReplyCount(String[] types, String keyword, Pageable pageable) {
        ...
        jpql.append(" GROUP BY b ");    // 게시글에 따른 댓글 카운트를 가져오기 위한 group by 사용
    ...
    /**
     * 게시글의 일부 정보 및 댓글 카운트, 이미지 미리보기 정보
     * @param types
     * @param keyword
     * @param pageable
     * @return
    ...
    public Page<BoardListAllDTO> searchWithAllNew(String[] types, String keyword, Pageable pageable) {
        ...
        // 가져온 게시물 번호 리스트 저장(for 첨부 파일 이미지 조회)
        ...
        // 게시물별로 첨부 파일 이미지를 그룹화하여 dto로 생성
        ...
        // 정렬된 결과를 유지하기 위해 다시 bno 기준으로 다시 정렬
