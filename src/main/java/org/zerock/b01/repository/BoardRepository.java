...
public interface BoardRepository extends JpaRepository<Board, Long>, BoardSearch {
    ...
    Page<Board> findKeyword(@Param("keyword") String keyword, Pageable pageable); // findByTitleContainingOrderByBnoDesc 같음

    // N 개수 만큼 select하는 것이 아니라 한꺼번에 imageSet으로 가져오는 방법
